...
│   │   ├── editorial.md            # 題目解析
│   │   ├── progress.json           # 使用者進度（已加入 gitignore）
│   │   ├── testcases_visible.json
│   │   └── testcases_hidden.json
│   └── add-two-integers/           # 內建題目
│       ├── problem.json
│       ├── template.java
│       ├── template.py
│       ├── editorial.md
